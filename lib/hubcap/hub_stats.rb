...
module Hubcap
  class HubStats
    ...
    def initialize(opts)
      ...
      @repos = {}
      repo_list_url = URI.parse("https://github.com/api/v2/json/repos/show/#{@login}?page=1")
      while repo_list_url
      ...
      @repos.each_pair do |repo_name, data|
        participation_url = URI.parse("https://github.com/#{@login}/#{repo_name}/graphs/participation")
